...
public interface ChatMessageMapper {
	...
	@Insert("""
			INSERT INTO chat_message (session_id, role, content,content_html, message_type, metadata, create_time)
			VALUES (#{sessionId}, #{role}, #{content},#{contentHtml}, #{messageType}, #{metadata}, NOW())
			""")
