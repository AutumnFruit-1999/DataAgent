...
public class GraphController {
    ...
    @GetMapping("/stream/graphState/{threadId}")
    public ResponseEntity<Map<String, Object>> getGraphState(@PathVariable String threadId) {
        OverAllState state = graphService.getGraphState(threadId).state();
        return ResponseEntity.ok(state.data());
    }
